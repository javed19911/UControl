...
public class AppPreferencesHelper implements PreferencesHelper {
    ...
    private static final String PREF_KEY_COMMODITIES = "PREF_KEY_COMMODITIES";
    ...
    public Boolean isRememberCredentials() {
        return mPrefs.getBoolean(PREF_KEY_REMEMBER_CREDENTIALS, false);
    }

    @Override
    public void setRememberCredentials(Boolean rememberCredentials) {
        mPrefs.edit().putBoolean(PREF_KEY_REMEMBER_CREDENTIALS, rememberCredentials).apply();
    }
    ...
    public ArrayList<String> getCommodities() {
        String commoditiesStr = mPrefs.getString(PREF_KEY_COMMODITIES, null);
        return Converters.fromString(commoditiesStr);
    }

    @Override
    public void saveCommodities(ArrayList<String> commodities) {
        mPrefs.edit().putString(PREF_KEY_COMMODITIES, Converters.fromArrayLisr(commodities)).apply();
    }
}
